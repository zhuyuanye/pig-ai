...
package com.pig4cloud.pig.collector.collect.database;
...
import com.pig4cloud.pig.collector.collect.common.cache.JdbcConnect;
import com.pig4cloud.pig.collector.collect.common.ssh.SshTunnelHelper;
...
import com.pig4cloud.pig.common.core.entity.job.SshTunnel;
import com.pig4cloud.pig.common.core.entity.job.protocol.JdbcProtocol;
...
/*            case "postgresql" -> "jdbc:postgresql://" + host + ":" + port
            ...
            case "postgresql" -> {
                if (jdbcProtocol.getDatabase().equals("highgo")){
                        yield  "jdbc:highgo://" + host + ":" + port
                        + "/" + (jdbcProtocol.getDatabase() == null ? "" : jdbcProtocol.getDatabase())
                            + "?useUnicode=true&characterEncoding=utf-8&ssl=false&sslmode=disable";
                }else {
                        yield "jdbc:postgresql://" + host + ":" + port
                            + "/" + (jdbcProtocol.getDatabase() == null ? "" : jdbcProtocol.getDatabase());
                }
            }

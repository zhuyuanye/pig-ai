...
package com.pig4cloud.pig.collector.collect.kafka;
...
import com.pig4cloud.pig.collector.collect.kafka.constants.InternalTopic;
import com.pig4cloud.pig.collector.collect.kafka.constants.SupportedCommand;
import com.pig4cloud.pig.collector.dispatch.DispatchConstants;
import com.pig4cloud.pig.common.core.entity.job.Metrics;
import com.pig4cloud.pig.common.core.entity.job.protocol.KafkaProtocol;
...
public class KafkaCollectImpl extends AbstractCollect {
    ...
    private static Map<String, Set<String>> getTopicConsumerGroupsMap(Collection<ConsumerGroupListing> consumerGroups,
        ...
        for (ConsumerGroupListing consumerGroup : consumerGroups) {
            ...
            for (Entry<TopicPartition, OffsetAndMetadata> entry : topicOffsets.entrySet()) {

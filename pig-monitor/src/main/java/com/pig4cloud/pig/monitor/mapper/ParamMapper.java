...
public interface ParamMapper extends BaseMapper<Param> {
	 ...
	 * @return 参数列表
	 */
	List<Param> findParamsByMonitorId(@org.apache.ibatis.annotations.Param("monitorId") Long monitorId);
	 ...
	 * @param monitorId 监控任务ID
	 */
	void deleteParamsByMonitorId(@org.apache.ibatis.annotations.Param("monitorId") long monitorId);
	 ...
	 */
	void deleteParamsByMonitorIdIn(@org.apache.ibatis.annotations.Param("monitorIds") Set<Long> monitorIds);

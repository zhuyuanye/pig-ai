>将 SkyWalking 的告警通过 Webhook 方式发送到告警平台。

### SkyWalking 服务配置

- 编辑 SkyWalking 配置文件 `alarm-settings.yml`
```yaml
hooks:
  webhook:
    default:
...
```
- `http://{hertzbeat_host}:1157/api/alerts/report/skywalking` 提供的 webhook 接口地址

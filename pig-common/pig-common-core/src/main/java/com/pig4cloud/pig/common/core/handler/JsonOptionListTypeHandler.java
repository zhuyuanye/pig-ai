...
/**
 * JSON Option List 绫诲瀷澶勭悊鍣?
 * <p>
 * 鐢ㄤ簬澶勭悊鏁版嵁搴撲腑瀛樺偍鐨凧SON鏍煎紡瀛楃涓蹭笌Java Option瀵硅薄鍒楄〃鐨勭浉浜掕浆鎹?
 * <p>
 * 鏀寔灏嗘暟鎹簱涓殑VARCHAR绫诲瀷瀛楁锛堝瓨鍌↗SON鏁扮粍瀛楃涓诧級鑷姩杞崲涓篔ava鐨凩ist瀵硅薄锛?
 * 浠ュ強灏哃ist瀵硅薄搴忓垪鍖栦负JSON瀛楃涓插瓨鍌ㄥ埌鏁版嵁搴?
 *
 * @author HertzBeat
 * @since 1.0.0
 */
...
public class JsonOptionListTypeHandler extends BaseTypeHandler<List<Object>> {
	 ...
	 * <p>
	 * 灏哃ist瀵硅薄搴忓垪鍖栦负JSON瀛楃涓插悗璁剧疆鍒癙reparedStatement鐨勬寚瀹氫綅缃?
	 *
	 * @param ps        PreparedStatement瀵硅薄
	 * @param i         鍙傛暟浣嶇疆
	 * @param parameter List绫诲瀷鍙傛暟鍊?
	...
	/**
	 * 鏍规嵁鍒楀悕浠嶳esultSet涓幏鍙栧彲绌虹殑List缁撴灉
	 * <p>
	 * 浠庣粨鏋滈泦涓幏鍙栨寚瀹氬垪鍚嶇殑JSON瀛楃涓诧紝骞跺弽搴忓垪鍖栦负List瀵硅薄
	 *
	 * @param rs         ResultSet瀵硅薄
	 * @param columnName 鍒楀悕
	 * @return List瀵硅薄锛屽鏋淛SON涓虹┖鎴栬В鏋愬け璐ュ垯杩斿洖绌篖ist
	...
	/**
	 * 鏍规嵁鍒椾綅缃粠ResultSet涓幏鍙栧彲绌虹殑List缁撴灉
	 * <p>
	 * 浠庣粨鏋滈泦涓幏鍙栨寚瀹氬垪浣嶇疆鐨凧SON瀛楃涓诧紝骞跺弽搴忓垪鍖栦负List瀵硅薄
	 *
	 * @param rs          ResultSet瀵硅薄
	...
	/**
	 * 浠嶤allableStatement涓幏鍙栧彲绌虹殑List缁撴灉
	 * <p>
	 * 浠庡瓨鍌ㄨ繃绋嬭皟鐢ㄨ鍙ヤ腑鑾峰彇鎸囧畾鍒椾綅缃殑JSON瀛楃涓诧紝骞跺弽搴忓垪鍖栦负List瀵硅薄
	 *
	...
	/**
	 * 瑙ｆ瀽JSON瀛楃涓蹭负List瀵硅薄
	 * <p>
	 * 灏嗘暟鎹簱涓殑JSON鏁扮粍瀛楃涓插弽搴忓垪鍖栦负List瀵硅薄锛屽鏋滃瓧绗︿覆涓虹┖鎴栬В鏋愬け璐ュ垯杩斿洖绌篖ist
	 *
	 * @param json JSON鏍煎紡瀛楃涓?
	 * @return List瀵硅薄锛屼笉涓簄ull
	 */

...
package com.pig4cloud.pig.common.collector.collect.common.cache;
...
public class GlobalConnectionCache {
    ...
    /**
     * Default cache time: 180 seconds (3 minutes for IPMI compatibility)
     */
    private static final long DEFAULT_CACHE_TIMEOUT = 180 * 1000L;

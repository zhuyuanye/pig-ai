...
package com.pig4cloud.pig.common.warehouse.store.history.vm;
...
import com.pig4cloud.pig.common.core.timer.HashedWheelTimer;
...
public class VictoriaMetricsDataStorage extends AbstractHistoryDataStorage {
    ...
    private final BlockingQueue<VictoriaMetricsContent> metricsBufferQueue;
     ...
     */
    private void sendVictoriaMetrics(List<VictoriaMetricsContent> contentList) {
    ...
    private class MetricsFlushTask implements TimerTask {
        ...
        public void run(Timeout timeout) {
            try {
                List<VictoriaMetricsContent> batch = new ArrayList<>(victoriaMetricsProp.insert().bufferSize());

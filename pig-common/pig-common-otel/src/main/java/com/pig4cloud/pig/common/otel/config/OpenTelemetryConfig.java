...
package com.pig4cloud.pig.common.otel.config;
...
import com.pig4cloud.pig.common.warehouse.store.history.greptime.GreptimeProperties;
...
public class OpenTelemetryConfig {
    ...
    private static final String PIG_SERVICE_NAME = "PigMonitor";
    ...
    public AutoConfigurationCustomizerProvider greptimeOtelCustomizer(GreptimeProperties greptimeProperties) {
        ...
        return providerCustomizer -> providerCustomizer
                ...
                .addResourceCustomizer((resource, configProperties) -> {
                    log.info("Customizing auto-configured OpenTelemetry Resource with service name: {}.", PIG_SERVICE_NAME);
                    return resource.merge(Resource.builder().put(SERVICE_NAME, PIG_SERVICE_NAME).build());
                })
